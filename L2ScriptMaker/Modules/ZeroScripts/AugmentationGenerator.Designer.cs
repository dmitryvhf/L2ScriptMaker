namespace L2ScriptMaker.Modules.ZeroScripts
{
	partial class AugmentationGenerator
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AugmentationGenerator));
			...
			this.Label2.Text = "Augmentation Generator from client .Dat file";
			// 
			// QuitButton
			// 
			this.QuitButton.Location = new System.Drawing.Point(143, 74);
			...
			// StartButton
			// 
			this.StartButton.Location = new System.Drawing.Point(143, 45);
			...
			this.Name = "AugmentationGenerator";
