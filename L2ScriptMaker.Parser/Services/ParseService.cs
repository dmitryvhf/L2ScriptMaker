...
namespace L2ScriptMaker.Parsers.Services
{
	public static class ParseService
	{
		...
		public static ParsedData ToKeyValueCollection(string raw)
		{
			...
			string[] splited = refinedRaw.Split(ParseConstants.SplitChars, StringSplitOptions.RemoveEmptyEntries);
		...
		public static Maybe<ParsedLine> ParseSimple(string row)
		{
			...
			result.Values = cleanedRaw
				.Split(ParseConstants.SpaceSplitChars, StringSplitOptions.RemoveEmptyEntries);
